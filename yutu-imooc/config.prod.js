...
window.global_config = {
  ...
  system: {
    ...
    logoutUrl: 'http://222.190.118.45:18080/authservice' + '/auth/session/logout?redirect_uri=http://localhost:1609', // 退出登录地址,
  ...
  map: {
    ...
    [vector.value]: {
      ...
      view_config: {
        ...
        projection: {
          code: 'EPSG:4545',
          definition: '+proj=tmerc +lat_0=0 +lon_0=120 +k=1.0 +x_0=500000 +y_0=0 +ellps=GRS80 +units=m +no_defs',
        },
        // 地图范围配置
        extent: {
    ...
    [images.value]: {
      ...
      layer_config: {
        ...
        resolutions: [
          541.8677504021675, 270.93387520108377, 135.46693760054188, 67.73346880027094, 33.86673440013547, 16.933367200067735, 8.466683600033868, 4.233341800016934, 2.116670900008467,
          1.0583354500042335, 0.5291677250021167, 0.26458386250105836, 0.13229193125052918, 0.06614596562526459,
        ],
      },
    },
  },
