    ...
    <template v-if="viewMode === 'list'">
      <div class="py-4 bg-white">
        ...
        <div class="mt-4 mx-2 flex items-center justify-between">
          <div>
            ...
            <el-button
              type="primary"
              @click="onExport(props.headerMap, `${props.title}数据`)"
            >
      ...
      <div class="flex-1 overflow-hidden">
        ...
        >
          ...
          <el-table-column
            :label="`${props.title}${props.metricLabel}`"
            width="130"
            align="right"
          >
            <template #default="{ row }"
              >{{ row[props.metricProp] }} {{ props.metricUnit }}</template
            >
          </el-table-column>
          <el-table-column
            prop="segmentCount"
            ...
            <div class="grid grid-cols-2 gap-x-6">
              <el-form-item :label="`${segmentLabel}名称`" required>
                <el-input
                  ...
                  :placeholder="`请输入${segmentLabel}名称`"
                />
              </el-form-item>
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="text-xs text-gray-500">
                  ...
                  <span v-if="props.drawType !== 'Point'"
                    >，{{ props.metricLabel }}：{{ drawnMetric }}</span
                  >
                </div>
              </div>
