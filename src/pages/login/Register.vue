<template>
  <div class="register-container flex items-center justify-center h-screen w-screen overflow-hidden">
      ...
      >
        ...
        <el-form-item prop="agree">
          <el-checkbox v-model="registerForm.agree" class="custom-checkbox">
            <span class="text-white/60 text-xs">我已阅读并同意 <a href="#" class="text-blue-400">《服务协议》</a> 与 <a href="#" class="text-blue-400">《隐私政策》</a></span>
          </el-checkbox>
        </el-form-item>
    ...
    <!-- 装饰性背景图 (无人车) -->
    <div class="absolute left-0 bottom-0 w-1/3 opacity-10 pointer-events-none">
      <img src="@/assets/car.png" alt="car" class="w-full object-contain -translate-x-1/4 translate-y-1/4 rotate-[15deg] flip-x" />
    </div>
  </div>
</template>
...
.flip-x {
  transform: scaleX(-1) rotate(15deg) translate(25%, 25%);
}
